...
import { MANIFIESTO_LINES, SOMOS } from "@/lib/content";

/**
 * Manifiesto — declaración editorial en serif sobre fondo cálido,
 * cerrada con el marquee de personalidad de marca ("somos").
 */
export function Manifiesto() {
  return (
    <>
      ...
      {/* Marquee de personalidad */}
      <div className="border-y border-brown/15 bg-cream py-6 text-brown">
        <Marquee
          items={SOMOS}
          duration={42}
          separator="✦"
          className="display text-[clamp(1.6rem,4vw,2.8rem)]"
        />
      </div>
    </>
  );
